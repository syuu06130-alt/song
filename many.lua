-- ==============================================================
--   🎸 Libra Heart  (imaizumi)  [Complete Edition] + 追加楽曲
...
local function playSong(notesTable, title)
    ...
    Rayfield:Notify({Title="♪ "..title,Content="演奏開始！ ("..#notesTable.."ノーツ)",Duration=3,Image="rbxassetid://4483345998"})
    task.spawn(function()
...
-- ── 追加楽曲ノーツデータ ──────────────────────────────────────
local notes_twinkle = {
    {time=0.0, key="1"}, {time=0.5, key="1"}, {time=1.0, key="5"}, {time=1.5, key="5"},
    {time=2.0, key="6"}, {time=2.5, key="6"}, {time=3.0, key="5"}, 
    {time=4.0, key="4"}, {time=4.5, key="4"}, {time=5.0, key="3"}, {time=5.5, key="3"},
    {time=6.0, key="2"}, {time=6.5, key="2"}, {time=7.0, key="1"}
}

local notes_ode_to_joy = {
    {time=0.00, key="3"}, {time=0.50, key="3"}, {time=1.00, key="4"}, {time=1.50, key="5"},
    {time=2.00, key="5"}, {time=2.50, key="4"}, {time=3.00, key="3"}, {time=3.50, key="2"},
    {time=4.00, key="1"}, {time=4.50, key="1"}, {time=5.00, key="2"}, {time=5.50, key="3"},
    {time=6.00, key="3"}, {time=6.75, key="2"}, {time=7.00, key="2"}
}

local notes_happy_birthday = {
    {time=0.00, key="1"}, {time=0.25, key="1"},
    {time=0.50, key="2"}, {time=1.00, key="1"}, {time=1.50, key="4"},
    {time=2.00, key="3"},
    {time=3.00, key="1"}, {time=3.25, key="1"},
    {time=3.50, key="2"}, {time=4.00, key="1"}, {time=4.50, key="5"},
    {time=5.00, key="4"},
    {time=6.00, key="1"}, {time=6.25, key="1"},
    {time=6.50, key="8"}, {time=7.00, key="6"}, {time=7.50, key="4"},
    {time=8.00, key="3"}, {time=8.50, key="2"},
    {time=9.00, key="^"}, {time=9.25, key="^"},
    {time=9.50, key="6"}, {time=10.00, key="4"}, {time=10.50, key="5"},
    {time=11.00, key="4"}
}

-- ── Rayfield UI ─────────────────────────────────────────────
local Window = Rayfield:CreateWindow({
    Name            = "🎸 Libra Heart & Minisongs",
...
-- ── Main タブ ──
local MainTab = Window:CreateTab("🎹 演奏", 4483345998)
...
MainTab:CreateButton({
    Name     = "▶  歓喜の歌 / Ode to Joy (約8秒)",
    Callback = function() playSong(notes_ode_to_joy, "歓喜の歌") end,
})

MainTab:CreateButton({
    Name     = "▶  Happy Birthday to You (約12秒)",
    Callback = function() playSong(notes_happy_birthday, "Happy Birthday") end,
})
