-- ==============================================================
--   🎸 Piano Player v4  [15曲収録]
--   Virtual Piano Player  ―  Rayfield UI
--   キーマップ: 画像ピアノ準拠（White: 1〜m / Black: !〜B）
--   Libra Heart: basic_pitch_transcription__2_.mid より変換
-- ==============================================================
...
-- ── ピッチマップ（キー → MIDI番号 / melodyOnly用）──────────
local PITCH = {
    -- オクターブ4 (C4=60)
    ["1"]=60,["!"]=61,["2"]=62,["@"]=63,["3"]=64,
    ["4"]=65,["$"]=66,["5"]=67,["%"]=68,["6"]=69,["^"]=70,["7"]=71,
    -- オクターブ5 (C5=72)
    ["8"]=72,["*"]=73,["9"]=74,["("]=75,["0"]=76,
    ["q"]=77,["Q"]=78,["w"]=79,["W"]=80,["e"]=81,["E"]=82,["r"]=83,
    -- オクターブ6 (C6=84)
    ["t"]=84,["T"]=85,["y"]=86,["Y"]=87,["u"]=88,
    ["i"]=89,["I"]=90,["o"]=91,["O"]=92,["p"]=93,["P"]=94,["a"]=95,
    -- オクターブ7 (C7=96)
    ["s"]=96,["S"]=97,["d"]=98,["D"]=99,["f"]=100,
    ["g"]=101,["G"]=102,["h"]=103,["H"]=104,["j"]=105,["J"]=106,["k"]=107,
    -- オクターブ8 (C8=108)
    ["l"]=108,["L"]=109,["z"]=110,["Z"]=111,["x"]=112,
    ["c"]=113,["C"]=114,["v"]=115,["V"]=116,["b"]=117,["B"]=118,
    ["n"]=119,["m"]=120,
}
...
local notes_libra1 = {
    ...
    {time=85.016,key="Q"},{time=85.075,key="S"},{time=85.260,key="$"},{time=85.458,key="*"},
    ...
    {time=87.490,key="4"},{time=87.503,key="%"},{time=87.537,key="S"},{time=87.792,key="*"},
    ...
    {time=165.037,key="@"},{time=165.060,key="S"},{time=165.258,key="*"},{time=165.258,key="$"},
    ...
    {time=166.337,key="S"},{time=166.513,key="!"},{time=166.757,key="4"},{time=166.768,key="Q"},
    ...
    {time=167.511,key="Q"},{time=167.511,key="%"},{time=167.511,key="!"},{time=167.546,key="S"},
    ...
    {time=212.263,key="^"},{time=212.518,key="!"},{time=212.751,key="Q"},{time=212.762,key="S"},
    ...
    {time=213.516,key="7"},{time=213.656,key="S"},{time=213.992,key="!"},{time=214.004,key="q"},
    ...
    {time=215.004,key="$"},{time=215.120,key="S"},{time=215.503,key="Q"},{time=215.503,key="4"},
    ...
    {time=221.498,key="E"},{time=221.498,key="7"},{time=221.521,key="7"},{time=221.741,key="S"},
...
local Win = Rayfield:CreateWindow({
    Name            = "🎸 Piano Player v4 — 15曲収録",
    LoadingTitle    = "Piano Player v4",
    LoadingSubtitle = "Libra Heart MIDIデータ使用 / 正確キーマップ",
...
LT:CreateButton({ Name="▶  Libra Heart 2 — Full (~27s)",   Callback=function() playSong(notes_libra2,"Libra Heart 2") end })
LT:CreateButton({ Name="▶  Libra Heart 2 — Melody Only",   Callback=function() playSong(melodyOnly(notes_libra2),"LH2 [MELODY]") end })

LT:CreateSection("Libra Heart 1")
LT:CreateButton({ Name="▶  Full Play (~222s)",              Callback=function() playSong(notes_libra1,"Libra Heart") end })
...
LT:CreateButton({ Name="▶  FINALE [180-222s]",             Callback=function()
...
KT:CreateSection("童謡")
KT:CreateButton({ Name="▶  きらきら星 (~46s)",             Callback=function() playSong(notes_twinkle,"きらきら星") end })
...
ST:CreateParagraph({
    Title="Speed の使い方",
    Content="先にSpeedを設定してから演奏ボタンを押す\n🐢 0.75x = 練習・確認用\n▶  1.0x  = 通常\n🚀 2.0x  = 早回しで確認",
})
...
SetT:CreateParagraph({
    ...
    Content=
        "【白鍵】\n"..
        "  Octave4: 1=C 2=D 3=E 4=F 5=G 6=A 7=B\n"..
        "  Octave5: 8=C 9=D 0=E q=F w=G e=A r=B\n"..
        "  Octave6: t=C y=D u=E i=F o=G p=A a=B\n"..
        "  Octave7: s=C d=D f=E g=F h=G j=A k=B\n"..
        "  Octave8: l=C z=D x=E c=F v=G b=A n=B m=C\n"..
        "【黒鍵 (Shift)】\n"..
        "  Oct4: !=C# @=D# $=F# %=G# ^=A#\n"..
        "  Oct5: *=C# (=D# Q=F# W=G# E=A#\n"..
        "  Oct6: T=C# Y=D# I=F# O=G# P=A#\n"..
        "  Oct7: S=C# D=D# G=F# H=G# J=A#\n"..
        "  Oct8: L=C# Z=D# C=F# V=G# B=A#",
})
